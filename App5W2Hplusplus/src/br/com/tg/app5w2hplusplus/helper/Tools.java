...
public class Tools {
	 ...
	 * 
	 * @param preferences
	 *            : The SharedPreferences of the application in which is stored
	 *            the last opening date.
	 * @return True if the splash screen has not been open for
	 ...
	 */
	/**
	 * Function used to convert a date in string format to a date. Respect the
	 * date format of the date return by the web services.
	 * 
	 * @param stringDate
	 *            : The string date with the format given in the constant
	 *            {@link:Constants.DATE_FORMAT}
	...
	/**
	 * Function used to convert a date a string date. Respect the date format of
	 * the date return by the web services.
	 * 
	 * @param theDate
	 *            : The date to convert
	 * @return The string date with the format given in the constant
	 *         {@link:Constants.DATE_FORMAT}
	 */
