...
public class Redirector {
	...
	/**
	 * This function will check if a redirection need to be made.
	 * It's launched at the beginning of onResume()
	 * @param activity
	 */
  ...
  /**
	 ...
	 * For example, we can launch the splash screen or the login activity before the home.
	 * @return The intent for the redirected activity, null if no redirection needed.
	 */
